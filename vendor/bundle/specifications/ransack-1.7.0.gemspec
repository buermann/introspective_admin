...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<polyamorous>.freeze, ["~> 1.2"])
      ...
      s.add_development_dependency(%q<pry>.freeze, ["= 0.9.12.2"])
    else
      ...
      s.add_dependency(%q<polyamorous>.freeze, ["~> 1.2"])
      ...
      s.add_dependency(%q<pry>.freeze, ["= 0.9.12.2"])
    end
  else
    s.add_dependency(%q<actionpack>.freeze, [">= 3.0"])
    s.add_dependency(%q<activerecord>.freeze, [">= 3.0"])
